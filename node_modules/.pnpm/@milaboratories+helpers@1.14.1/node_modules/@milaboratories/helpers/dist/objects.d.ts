import { PlainObject } from "./types/index.js";

//#region src/objects.d.ts
declare namespace objects_d_exports {
  export { bindMethods, deepClone, deepEqual, deepPatch, getProp, isArray, isJsonEqual, isNonPrimitive, isObject, isPlainObject, map, omit, pick, pickValues, setProp, shallowClone, shallowDiff, shiftProp };
}
/**
 * Alias to Array.isArray
 */
declare const isArray: (arg: any) => arg is any[];
declare function isNonPrimitive<V, T extends PlainObject<V> | V[]>(obj: T | unknown): obj is T;
...
declare function map<U, T extends Record<string, unknown>>(obj: T, callback: (curr: T[keyof T], key: keyof T) => U): U[];
/**
 ...
 */
declare const deepEqual: typeof isJsonEqual;
declare function deepClone<T>(obj: T): T;
declare function shallowClone<T>(obj: T): T;
declare function shallowDiff<T>(to: T, from: T): Partial<T>;
declare function bindMethods<O extends Record<string, unknown>>(obj: O): O;
declare function setProp<O, K extends keyof O>(obj: O, key: K, value: O[K]): O;
declare function getProp<O, K extends keyof O>(obj: O, key: K): O[K];
declare function shiftProp<O, K extends keyof O>(obj: O, key: K): [O[K], Omit<O, K>];
declare function pick<T, K extends keyof T>(obj: T, ...keys: K[]): Pick<T, K>;
declare function pickValues<T, K extends keyof T>(obj: T, ...keys: K[]): T[K][];
 ...
 * ```
 */
declare function deepPatch<T extends PlainObject | unknown[]>(target: T, source: T): T;
//#endregion
export { bindMethods, deepClone, deepEqual, deepPatch, getProp, isArray, isJsonEqual, isNonPrimitive, isObject, isPlainObject, map, objects_d_exports, omit, pick, pickValues, setProp, shallowClone, shallowDiff, shiftProp };
