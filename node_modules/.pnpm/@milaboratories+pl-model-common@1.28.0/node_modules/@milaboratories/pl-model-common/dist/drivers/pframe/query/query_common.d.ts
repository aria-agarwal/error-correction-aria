 ...
 */
type TypeSpec = {
  /** List of axis value types defining the dimensions of the data */axes: AxisValueType[]; /** List of column value types defining the data stored */
 ...
 */
type NumericBinaryOperand = "add" | "sub" | "mul" | "div" | "mod";
/**
 ...
 * }
 */
interface QuerySliceAxes<Q, A extends QueryAxisSelector<unknown>> {
  type: "sliceAxes";
  /** Input query to slice */
  input: Q;
  /** List of axis filters to apply (at least one required) */
  axisFilters: {
    /** Selector identifying which axis to filter */axisSelector: A; /** The constant value to filter the axis to */
 ...
 * }
 */
interface QuerySparseToDenseColumn<C, SO> {
  type: "sparseToDenseColumn";
  /** Column reference (ID or full column object depending on context) */
  column: C;
