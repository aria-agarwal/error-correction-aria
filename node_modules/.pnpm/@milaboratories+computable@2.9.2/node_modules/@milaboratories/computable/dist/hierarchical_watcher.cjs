...
//#region src/hierarchical_watcher.ts
/**
...
*/
const activePendingWatchers = /* @__PURE__ */ new Map();
/**
...
var HierarchicalWatcher = class {
	...
	*/
	...
	setParent(parent) {
		...
		if (this.parent !== void 0) throw new Error("parent can be set only if it wasn't reset");
		this.parent = parent;
	}
	resetParent() {
		this.parent = void 0;
	...
	markChanged(marker) {
		...
		if (this.onChangeCallbacks !== void 0) {
			this.onChangeCallbacks.forEach((cb) => cb());
			this.onChangeCallbacks = void 0;
		}
	...
	awaitChange(abortSignal) {
		if (this.changed) return Promise.resolve();
		if (this.onChangeCallbacks === void 0) this.onChangeCallbacks = /* @__PURE__ */ new Map();
		const callbacks = this.onChangeCallbacks;
		const callId = Symbol();
		activePendingWatchers.set(callId, this);
		if (abortSignal !== void 0) return new Promise((res, rej) => {
			if (abortSignal.aborted) {
				rej(new _milaboratories_ts_helpers.Aborted(abortSignal.reason));
				return;
			}
			const abortCb = () => {
...
//#endregion
exports.HierarchicalWatcher = HierarchicalWatcher;
//# sourceMappingURL=hierarchical_watcher.cjs.map