//#region src/demo-site-data/all-css-variables.ts
function e() {
	return {
		txtSec: {
			title: "Text",
		...
		gradientSec: {
			...
			data: {
				"--gradient-blue-green": {
					light: [!0, !0],
					value: ["linear-gradient(0deg, #478063 0%, #2E4652 45.93%, #24223D 91.63%)", "linear-gradient(0deg, #478063 0%, #2E4652 45.93%, #24223D 91.63%)"],
...
//#endregion
export { e as allCssVariables };

//# sourceMappingURL=all-css-variables.js.map