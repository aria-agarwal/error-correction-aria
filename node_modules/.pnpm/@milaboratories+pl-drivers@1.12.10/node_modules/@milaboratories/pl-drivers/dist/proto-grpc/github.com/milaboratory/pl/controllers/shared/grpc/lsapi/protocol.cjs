...
var LsAPI_ListItem$Type = class extends _protobuf_ts_runtime.MessageType {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case 11:
					...
					break;
				case 12:
					message.lastModified = require_timestamp.Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.lastModified);
					break;
				case 13:
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.version !== "") writer.tag(13, _protobuf_ts_runtime.WireType.LengthDelimited).string(message.version);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? _protobuf_ts_runtime.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const LsAPI_ListItem = new LsAPI_ListItem$Type();
var LsAPI_List$Type = class extends _protobuf_ts_runtime.MessageType {
	constructor() {
...
*/
const LsAPI_List_Request = new LsAPI_List_Request$Type();
var LsAPI_List_Response$Type = class extends _protobuf_ts_runtime.MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		for (let i = 0; i < message.items.length; i++) LsAPI_ListItem.internalBinaryWrite(message.items[i], writer.tag(1, _protobuf_ts_runtime.WireType.LengthDelimited).fork(), options).join();
		if (message.delimiter !== "") writer.tag(2, _protobuf_ts_runtime.WireType.LengthDelimited).string(message.delimiter);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? _protobuf_ts_runtime.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const LS = new _protobuf_ts_runtime_rpc.ServiceType("MiLaboratories.Controller.Shared.LS", [{
	name: "List",
