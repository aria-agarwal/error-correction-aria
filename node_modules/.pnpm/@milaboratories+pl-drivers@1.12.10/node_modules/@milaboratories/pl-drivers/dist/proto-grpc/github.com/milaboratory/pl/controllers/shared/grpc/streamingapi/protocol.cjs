...
var StreamingAPI$Type = class extends _protobuf_ts_runtime.MessageType {
	constructor() {
...
var StreamingAPI_LastLines$Type = class extends _protobuf_ts_runtime.MessageType {
	constructor() {
...
var StreamingAPI_Response$Type = class extends _protobuf_ts_runtime.MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.data.length) writer.tag(1, _protobuf_ts_runtime.WireType.LengthDelimited).bytes(message.data);
		if (message.size !== 0n) writer.tag(2, _protobuf_ts_runtime.WireType.Varint).uint64(message.size);
		if (message.newOffset !== 0n) writer.tag(3, _protobuf_ts_runtime.WireType.Varint).uint64(message.newOffset);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? _protobuf_ts_runtime.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
