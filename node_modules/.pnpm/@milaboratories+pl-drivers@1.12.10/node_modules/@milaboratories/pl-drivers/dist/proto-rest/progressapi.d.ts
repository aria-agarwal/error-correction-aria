//#region src/proto-rest/progressapi.d.ts
/**
...
interface components {
  schemas: {
    ...
    ProgressAPI_Report: {
      /** Format: float */progress: number;
      bytesProcessed: string;
      bytesTotal: string;
      done: boolean; /** @description Name of current progress stage (if any) */
      name: string;
    };
...
//#endregion
export { paths };
//# sourceMappingURL=progressapi.d.ts.map