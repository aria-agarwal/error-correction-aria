...
var objects_exports = /* @__PURE__ */ require_runtime.__exportAll({
...
function shallowClone(obj) {
	if (require_utils.isNil(obj)) return obj;
...
exports.map = map;
Object.defineProperty(exports, 'objects_exports', {
  enumerable: true,
  get: function () {
    return objects_exports;
  }
});
exports.omit = omit;
exports.pick = pick;
