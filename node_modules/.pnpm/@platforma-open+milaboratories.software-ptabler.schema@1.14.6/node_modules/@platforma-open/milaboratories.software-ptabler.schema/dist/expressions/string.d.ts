...
//#region src/expressions/string.d.ts
/** Represents a string join operation on an array of expressions. */
interface StringJoinExpression {
...
type UnaryStringOperator = "to_upper" | "to_lower";
/** Represents a unary string operation on a single expression. */
interface ExtendedUnaryStringExpression {
 ...
 */
interface StringReplaceExpression {
 ...
 */
interface StringContainsExpression {
 ...
 */
interface StringStartsWithExpression {
 ...
 */
interface StringEndsWithExpression {
 ...
 */
interface StringContainsAnyExpression {
 ...
 */
interface StringCountMatchesExpression {
 ...
 */
interface StringExtractExpression {
...
//#endregion
export { ExtendedUnaryStringExpression, StringContainsAnyExpression, StringContainsExpression, StringCountMatchesExpression, StringEndsWithExpression, StringExtractExpression, StringJoinExpression, StringReplaceExpression, StringStartsWithExpression, SubstringExpression, UnaryStringOperator };
