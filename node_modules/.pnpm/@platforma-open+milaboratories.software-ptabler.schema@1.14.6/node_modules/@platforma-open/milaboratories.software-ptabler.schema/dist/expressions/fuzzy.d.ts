...
//#region src/expressions/fuzzy.d.ts
/** Defines the supported string distance metrics. */
type StringDistanceMetric = "levenshtein" | "optimal_string_alignment" | "jaro_winkler";
/**
 ...
 */
interface StringDistanceExpression {
...
type FuzzyFilterDistanceMetric = "levenshtein" | "hamming";
/**
 ...
 */
interface FuzzyStringFilterExpression {
...
//#endregion
export { FuzzyFilterDistanceMetric, FuzzyStringFilterExpression, StringDistanceExpression, StringDistanceMetric };
