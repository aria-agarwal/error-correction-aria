import { AggregationType } from "./expressions/window.js";
 ...
 */
type ByClauseAggregationType = "max_by" | "min_by";
/**
 * Represents a standard aggregation operation like sum, mean, count, etc.
 */
interface StandardAggregationOperation {
 ...
 */
interface ByClauseAggregationOperation {
  /** The name for the resulting column after aggregation. */
  name: string;
