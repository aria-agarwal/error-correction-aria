import { DataType } from "./common.js";
...
interface ReadCsvStep extends BaseFileReadStep {
...
interface ReadNdjsonStep extends BaseFileReadStep {
...
interface ReadParquetStep extends BaseFileReadStep {
 ...
 */
interface WriteCsvStep extends BaseFileWriteStep {
 ...
 */
interface WriteNdjsonStep extends BaseFileWriteStep {
 ...
 */
interface WriteParquetStep extends BaseFileWriteStep {
  /** The type of the step, which is always 'write_parquet' for this operation. */
  type: "write_parquet";
}
//#endregion
export { BaseFileReadStep, BaseFileWriteStep, ReadCsvStep, ReadNdjsonStep, ReadParquetStep, WriteCsvStep, WriteNdjsonStep, WriteParquetStep };
