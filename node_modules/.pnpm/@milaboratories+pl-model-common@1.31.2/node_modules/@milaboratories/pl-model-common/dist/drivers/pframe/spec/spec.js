...
*/
function resolveAnnotationParents(spec) {
	if (!spec.axesSpec.some((axis) => !!readAnnotationJson(axis, Annotation.Parents))) return spec;
	const denormalized = getDenormalizedAxesList(getNormalizedAxesList(spec.axesSpec));
	return {
		...spec,
		axesSpec: denormalized
	};
}
const PColumnName = {
	Label: "pl7.app/label",
