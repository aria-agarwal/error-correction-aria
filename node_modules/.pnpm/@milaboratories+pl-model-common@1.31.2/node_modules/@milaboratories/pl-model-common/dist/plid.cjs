...
const PlIdLength = 24;
const PlId = zod.z.string().length(24).regex(/[ABCDEFGHIJKLMNOPQRSTUVWXYZ234567]/).brand("PlId");
function uniquePlId() {
...
function plId(bytes) {
	if (bytes.length !== 15) throw new Error(`Wrong number of bytes: ${bytes.length}`);
