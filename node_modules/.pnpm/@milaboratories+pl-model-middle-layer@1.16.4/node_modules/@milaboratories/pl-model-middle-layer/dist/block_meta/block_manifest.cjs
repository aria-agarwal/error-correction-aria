...
const BlockPackDescriptionManifest = require_block_description.CreateBlockPackDescriptionSchema(BlockComponentsManifest, BlockPackMetaManifest);
const Sha256Schema = zod.z.string().regex(/[0-9a-fA-F]/).toUpperCase().length(64);
