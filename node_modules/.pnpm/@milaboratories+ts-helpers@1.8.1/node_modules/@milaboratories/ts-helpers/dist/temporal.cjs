...
async function sleep(timeout, abortSignal) {
	try {
		await node_timers_promises.setTimeout(timeout, void 0, { signal: abortSignal });
	} catch {
...
exports.Retry2Times = Retry2Times;
exports.Retry2TimesWithDelay = Retry2TimesWithDelay;
exports.Retry3Times = Retry3Times;
exports.Retry3TimesWithDelay = Retry3TimesWithDelay;
exports.createInfiniteRetryState = createInfiniteRetryState;
exports.createRetryState = createRetryState;
exports.jitter = jitter;
exports.msToHumanReadable = msToHumanReadable;
exports.nextInfiniteRetryState = nextInfiniteRetryState;
exports.nextRetryStateOrError = nextRetryStateOrError;
exports.retry = retry;
exports.sleep = sleep;
exports.tryNextRetryState = tryNextRetryState;
