...
async function asyncPool(initConcurrency, iterableFns) {
	let concurrency = initConcurrency;
	const controller = { setConcurrency: (n) => concurrency = n };
	const results = [];
...
var AsyncPoolError = class extends Error {
	name = "AsyncPoolError";
};

//#endregion
exports.AsyncPoolError = AsyncPoolError;
