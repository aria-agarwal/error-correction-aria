...
import { Controller, Field, Notification, Resource, ResourceAPIFeature, ResourceSchema, Subscription, Tx } from "./api_types.js";
...
*/
let TxAPI_Open_Request_WritableTx = /* @__PURE__ */ function(TxAPI_Open_Request_WritableTx) {
	/**
	* @generated from protobuf enum value: INVALID = 0;
	*/
	TxAPI_Open_Request_WritableTx[TxAPI_Open_Request_WritableTx["INVALID"] = 0] = "INVALID";
	/**
	* @generated from protobuf enum value: WRITABLE = 1;
	*/
	TxAPI_Open_Request_WritableTx[TxAPI_Open_Request_WritableTx["WRITABLE"] = 1] = "WRITABLE";
	/**
	* @generated from protobuf enum value: NOT_WRITABLE = 2;
	*/
	TxAPI_Open_Request_WritableTx[TxAPI_Open_Request_WritableTx["NOT_WRITABLE"] = 2] = "NOT_WRITABLE";
...
let MaintenanceAPI_Ping_Response_Compression = /* @__PURE__ */ function(MaintenanceAPI_Ping_Response_Compression) {
	...
	*/
	MaintenanceAPI_Ping_Response_Compression[MaintenanceAPI_Ping_Response_Compression["NONE"] = 0] = "NONE";
	/**
	* @generated from protobuf enum value: GZIP = 1;
	*/
	MaintenanceAPI_Ping_Response_Compression[MaintenanceAPI_Ping_Response_Compression["GZIP"] = 1] = "GZIP";
	return MaintenanceAPI_Ping_Response_Compression;
}({});
var TxAPI$Type = class extends MessageType {
	constructor() {
...
var TxAPI_ClientMessage$Type = class extends MessageType {
	constructor() {
		super("MiLaboratories.PL.API.TxAPI.ClientMessage", [
			...
			},
			{
				...
				kind: "message",
				oneof: "request",
				T: () => TxAPI_CloseStream_Request
			},
			{
				no: 58,
				name: "resource_create_root",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_CreateRoot_Request
			},
			{
				no: 57,
				...
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_Remove_Request
			},
			{
				no: 51,
				name: "resource_create_struct",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_CreateStruct_Request
			},
			{
				no: 62,
				name: "resource_create_ephemeral",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_CreateEphemeral_Request
			},
			{
				no: 52,
				name: "resource_create_value",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_CreateValue_Request
			},
			{
				no: 63,
				name: "resource_get_value_id",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_GetValueID_Request
			},
			{
				no: 64,
				name: "resource_create_singleton",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_CreateSingleton_Request
			},
			{
				no: 65,
				name: "resource_get_singleton",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_GetSingleton_Request
			},
			{
				no: 59,
				name: "resource_create_child",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_CreateChild_Request
			},
			{
				no: 53,
				name: "resource_lock_inputs",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_LockInputs_Request
			},
			{
				no: 56,
				name: "resource_lock_outputs",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_LockOutputs_Request
			},
			{
				no: 54,
			...
			},
			{
				...
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_Get_Request
			},
			{
				no: 61,
				name: "resource_set_error",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_SetError_Request
			},
			{
				no: 60,
				...
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_List_ByType_Request
			},
			{
				no: 66,
				name: "resource_name_set",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_Name_Set_Request
			},
			{
				no: 67,
				...
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_Name_Get_Request
			},
			{
				no: 68,
				name: "resource_name_exists",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_Name_Exists_Request
			},
			{
				no: 69,
				name: "resource_name_delete",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_Name_Delete_Request
			},
			{
				no: 70,
				name: "resource_tree",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_Tree_Request
			},
			{
				no: 71,
				name: "resource_tree_size",
				kind: "message",
				oneof: "request",
				T: () => ResourceAPI_TreeSize_Request
			},
			{
				no: 101,
				name: "field_create",
			...
			},
			{
				...
				kind: "message",
				oneof: "request",
				T: () => SubscriptionAPI_CreateSubscription_Request
			},
			{
				no: 112,
				name: "subscription_attach_filter",
				kind: "message",
				oneof: "request",
				T: () => SubscriptionAPI_AttachFilter_Request
			},
			{
				no: 113,
				name: "subscription_detach_filter",
				kind: "message",
				oneof: "request",
				T: () => SubscriptionAPI_DetachFilter_Request
			},
			{
				no: 115,
				name: "subscription_create_filter",
				kind: "message",
				oneof: "request",
				T: () => SubscriptionAPI_CreateFilter_Request
			},
			{
				no: 154,
			...
			},
			{
				...
				kind: "message",
				oneof: "request",
				T: () => NotificationAPI_Ack_Request
			},
			{
				no: 156,
				name: "notification_discard",
				kind: "message",
				oneof: "request",
				T: () => NotificationAPI_Discard_Request
			},
			{
				no: 200,
				name: "resource_key_value_set",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_Set_Request
			},
			{
				no: 201,
				name: "resource_key_value_get",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_Get_Request
			},
			{
				no: 202,
				name: "resource_key_value_get_if_exists",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_GetIfExists_Request
			},
			{
				no: 203,
				name: "resource_key_value_set_flag",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_SetFlag_Request
			},
			{
				no: 204,
				name: "resource_key_value_get_flag",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_GetFlag_Request
			},
			{
				no: 205,
				name: "resource_key_value_get_flag_if_exists",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_GetFlag_Request
			},
			{
				no: 206,
				name: "resource_key_value_delete",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_Delete_Request
			},
			{
				no: 207,
				name: "resource_key_value_list",
				kind: "message",
				oneof: "request",
				T: () => ResourceKVAPI_List_Request
			},
			{
				no: 250,
				name: "controller_key_value_set",
				kind: "message",
				oneof: "request",
				T: () => ControllerKVAPI_Set_Request
			},
			{
				no: 251,
				name: "controller_key_value_get",
				kind: "message",
				oneof: "request",
				T: () => ControllerKVAPI_Get_Request
			},
			{
				no: 252,
				name: "controller_key_value_get_if_exists",
				kind: "message",
				oneof: "request",
				T: () => ControllerKVAPI_GetIfExists_Request
			},
			{
				no: 253,
				name: "controller_key_value_set_flag",
				kind: "message",
				oneof: "request",
				T: () => ControllerKVAPI_SetFlag_Request
			},
			{
				no: 254,
				name: "controller_key_value_get_flag",
				kind: "message",
				oneof: "request",
				T: () => ControllerKVAPI_GetFlag_Request
			},
			{
				no: 255,
				name: "controller_key_value_get_flag_if_exists",
				kind: "message",
				oneof: "request",
				T: () => ControllerKVAPI_GetFlagIfExists_Request
			},
			{
				no: 300,
				name: "cache_set_to_field",
				kind: "message",
				oneof: "request",
				T: () => CacheAPI_SetToField_Request
			},
			{
				no: 301,
			...
			{
				no: 350,
				name: "controller_features_set",
				kind: "message",
				oneof: "request",
				T: () => ControllerAPI_SetFeatures_Request
			},
			{
				no: 351,
				name: "controller_features_clear",
				kind: "message",
				oneof: "request",
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case 11:
					message.request = {
						oneofKind: "txOpen",
						txOpen: TxAPI_Open_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.txOpen)
					};
					break;
				case 12:
					message.request = {
						oneofKind: "txCommit",
						txCommit: TxAPI_Commit_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.txCommit)
					};
					break;
				case 13:
					message.request = {
				...
				case 58:
					message.request = {
						...
						resourceCreateRoot: ResourceAPI_CreateRoot_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceCreateRoot)
					};
					break;
				case 57:
					message.request = {
						oneofKind: "resourceRemove",
						resourceRemove: ResourceAPI_Remove_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceRemove)
					};
					break;
				case 51:
					message.request = {
						oneofKind: "resourceCreateStruct",
						resourceCreateStruct: ResourceAPI_CreateStruct_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceCreateStruct)
					};
					break;
				case 62:
					message.request = {
						oneofKind: "resourceCreateEphemeral",
						resourceCreateEphemeral: ResourceAPI_CreateEphemeral_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceCreateEphemeral)
					};
					break;
				case 52:
					message.request = {
						oneofKind: "resourceCreateValue",
						resourceCreateValue: ResourceAPI_CreateValue_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceCreateValue)
					};
					break;
				case 63:
					message.request = {
						oneofKind: "resourceGetValueId",
						resourceGetValueId: ResourceAPI_GetValueID_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceGetValueId)
					};
					break;
				case 64:
					message.request = {
						oneofKind: "resourceCreateSingleton",
						resourceCreateSingleton: ResourceAPI_CreateSingleton_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceCreateSingleton)
					};
					break;
				case 65:
					message.request = {
						oneofKind: "resourceGetSingleton",
						resourceGetSingleton: ResourceAPI_GetSingleton_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceGetSingleton)
					};
					break;
				case 59:
					message.request = {
						oneofKind: "resourceCreateChild",
						resourceCreateChild: ResourceAPI_CreateChild_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceCreateChild)
					};
					break;
				case 53:
					message.request = {
						oneofKind: "resourceLockInputs",
						resourceLockInputs: ResourceAPI_LockInputs_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceLockInputs)
					};
					break;
				case 56:
					message.request = {
						oneofKind: "resourceLockOutputs",
						resourceLockOutputs: ResourceAPI_LockOutputs_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceLockOutputs)
					};
					break;
				case 54:
					message.request = {
						oneofKind: "resourceExists",
						resourceExists: ResourceAPI_Exists_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceExists)
					};
					break;
				case 55:
					message.request = {
						oneofKind: "resourceGet",
						resourceGet: ResourceAPI_Get_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceGet)
					};
					break;
				case 61:
					message.request = {
						oneofKind: "resourceSetError",
						resourceSetError: ResourceAPI_SetError_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceSetError)
					};
					break;
				case 60:
					message.request = {
						oneofKind: "resourceListByType",
						resourceListByType: ResourceAPI_List_ByType_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceListByType)
					};
					break;
				case 66:
					message.request = {
						oneofKind: "resourceNameSet",
						resourceNameSet: ResourceAPI_Name_Set_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceNameSet)
					};
					break;
				case 67:
					message.request = {
						oneofKind: "resourceNameGet",
						resourceNameGet: ResourceAPI_Name_Get_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceNameGet)
					};
					break;
				case 68:
					message.request = {
						oneofKind: "resourceNameExists",
						resourceNameExists: ResourceAPI_Name_Exists_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceNameExists)
					};
					break;
				case 69:
					message.request = {
						oneofKind: "resourceNameDelete",
						resourceNameDelete: ResourceAPI_Name_Delete_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceNameDelete)
					};
					break;
				case 70:
					message.request = {
						oneofKind: "resourceTree",
						resourceTree: ResourceAPI_Tree_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceTree)
					};
					break;
				case 71:
					message.request = {
						oneofKind: "resourceTreeSize",
						resourceTreeSize: ResourceAPI_TreeSize_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceTreeSize)
					};
					break;
				case 101:
					message.request = {
						oneofKind: "fieldCreate",
						fieldCreate: FieldAPI_Create_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldCreate)
					};
					break;
				case 107:
					message.request = {
						oneofKind: "fieldExists",
						fieldExists: FieldAPI_Exists_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldExists)
					};
					break;
				case 102:
					message.request = {
						oneofKind: "fieldSet",
						fieldSet: FieldAPI_Set_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldSet)
					};
					break;
				case 105:
					message.request = {
						oneofKind: "fieldSetError",
						fieldSetError: FieldAPI_SetError_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldSetError)
					};
					break;
				case 103:
					message.request = {
						oneofKind: "fieldGet",
						fieldGet: FieldAPI_Get_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldGet)
					};
					break;
				case 104:
					message.request = {
						oneofKind: "fieldReset",
						fieldReset: FieldAPI_Reset_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldReset)
					};
					break;
				case 106:
					message.request = {
						oneofKind: "fieldRemove",
						fieldRemove: FieldAPI_Remove_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldRemove)
					};
					break;
				case 108:
					message.request = {
						oneofKind: "fieldList",
						fieldList: FieldAPI_List_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.fieldList)
					};
					break;
				case 111:
					message.request = {
						oneofKind: "subscriptionCreate",
						subscriptionCreate: SubscriptionAPI_CreateSubscription_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.subscriptionCreate)
					};
					break;
				case 112:
					message.request = {
						oneofKind: "subscriptionAttachFilter",
						subscriptionAttachFilter: SubscriptionAPI_AttachFilter_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.subscriptionAttachFilter)
					};
					break;
				case 113:
					message.request = {
						oneofKind: "subscriptionDetachFilter",
						subscriptionDetachFilter: SubscriptionAPI_DetachFilter_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.subscriptionDetachFilter)
					};
					break;
				case 115:
					message.request = {
						oneofKind: "subscriptionCreateFilter",
						subscriptionCreateFilter: SubscriptionAPI_CreateFilter_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.subscriptionCreateFilter)
					};
					break;
				case 154:
					message.request = {
						oneofKind: "notificationGet",
						notificationGet: NotificationAPI_Get_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.notificationGet)
					};
					break;
				case 155:
					message.request = {
						oneofKind: "notificationAck",
						notificationAck: NotificationAPI_Ack_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.notificationAck)
					};
					break;
				case 156:
					message.request = {
						oneofKind: "notificationDiscard",
						notificationDiscard: NotificationAPI_Discard_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.notificationDiscard)
					};
					break;
				case 200:
					message.request = {
						oneofKind: "resourceKeyValueSet",
						resourceKeyValueSet: ResourceKVAPI_Set_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueSet)
					};
					break;
				case 201:
					message.request = {
						oneofKind: "resourceKeyValueGet",
						resourceKeyValueGet: ResourceKVAPI_Get_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueGet)
					};
					break;
				case 202:
					message.request = {
						oneofKind: "resourceKeyValueGetIfExists",
						resourceKeyValueGetIfExists: ResourceKVAPI_GetIfExists_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueGetIfExists)
					};
					break;
				case 203:
					message.request = {
						oneofKind: "resourceKeyValueSetFlag",
						resourceKeyValueSetFlag: ResourceKVAPI_SetFlag_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueSetFlag)
					};
					break;
				case 204:
					message.request = {
						oneofKind: "resourceKeyValueGetFlag",
						resourceKeyValueGetFlag: ResourceKVAPI_GetFlag_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueGetFlag)
					};
					break;
				case 205:
					message.request = {
						oneofKind: "resourceKeyValueGetFlagIfExists",
						resourceKeyValueGetFlagIfExists: ResourceKVAPI_GetFlag_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueGetFlagIfExists)
					};
					break;
				case 206:
					message.request = {
						oneofKind: "resourceKeyValueDelete",
						resourceKeyValueDelete: ResourceKVAPI_Delete_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueDelete)
					};
					break;
				case 207:
					message.request = {
						oneofKind: "resourceKeyValueList",
						resourceKeyValueList: ResourceKVAPI_List_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.resourceKeyValueList)
					};
					break;
				case 250:
					message.request = {
						oneofKind: "controllerKeyValueSet",
						controllerKeyValueSet: ControllerKVAPI_Set_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.controllerKeyValueSet)
					};
					break;
				case 251:
					message.request = {
						oneofKind: "controllerKeyValueGet",
						controllerKeyValueGet: ControllerKVAPI_Get_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.controllerKeyValueGet)
					};
					break;
				case 252:
					message.request = {
				...
				case 300:
					message.request = {
						...
						cacheSetToField: CacheAPI_SetToField_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.cacheSetToField)
					};
					break;
				case 301:
					message.request = {
				...
				case 350:
					message.request = {
						...
						controllerFeaturesSet: ControllerAPI_SetFeatures_Request.internalBinaryRead(reader, reader.uint32(), options, message.request.controllerFeaturesSet)
					};
					break;
				case 351:
					message.request = {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.requestId !== 0) writer.tag(1, WireType.Varint).uint32(message.requestId);
		if (message.request.oneofKind === "txOpen") TxAPI_Open_Request.internalBinaryWrite(message.request.txOpen, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "txCommit") TxAPI_Commit_Request.internalBinaryWrite(message.request.txCommit, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "txDiscard") TxAPI_Discard_Request.internalBinaryWrite(message.request.txDiscard, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "streamClose") TxAPI_CloseStream_Request.internalBinaryWrite(message.request.streamClose, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceCreateStruct") ResourceAPI_CreateStruct_Request.internalBinaryWrite(message.request.resourceCreateStruct, writer.tag(51, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceCreateValue") ResourceAPI_CreateValue_Request.internalBinaryWrite(message.request.resourceCreateValue, writer.tag(52, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceLockInputs") ResourceAPI_LockInputs_Request.internalBinaryWrite(message.request.resourceLockInputs, writer.tag(53, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceExists") ResourceAPI_Exists_Request.internalBinaryWrite(message.request.resourceExists, writer.tag(54, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceGet") ResourceAPI_Get_Request.internalBinaryWrite(message.request.resourceGet, writer.tag(55, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceLockOutputs") ResourceAPI_LockOutputs_Request.internalBinaryWrite(message.request.resourceLockOutputs, writer.tag(56, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceRemove") ResourceAPI_Remove_Request.internalBinaryWrite(message.request.resourceRemove, writer.tag(57, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceCreateRoot") ResourceAPI_CreateRoot_Request.internalBinaryWrite(message.request.resourceCreateRoot, writer.tag(58, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceCreateChild") ResourceAPI_CreateChild_Request.internalBinaryWrite(message.request.resourceCreateChild, writer.tag(59, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceListByType") ResourceAPI_List_ByType_Request.internalBinaryWrite(message.request.resourceListByType, writer.tag(60, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceSetError") ResourceAPI_SetError_Request.internalBinaryWrite(message.request.resourceSetError, writer.tag(61, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceCreateEphemeral") ResourceAPI_CreateEphemeral_Request.internalBinaryWrite(message.request.resourceCreateEphemeral, writer.tag(62, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceGetValueId") ResourceAPI_GetValueID_Request.internalBinaryWrite(message.request.resourceGetValueId, writer.tag(63, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceCreateSingleton") ResourceAPI_CreateSingleton_Request.internalBinaryWrite(message.request.resourceCreateSingleton, writer.tag(64, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceGetSingleton") ResourceAPI_GetSingleton_Request.internalBinaryWrite(message.request.resourceGetSingleton, writer.tag(65, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceNameSet") ResourceAPI_Name_Set_Request.internalBinaryWrite(message.request.resourceNameSet, writer.tag(66, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceNameGet") ResourceAPI_Name_Get_Request.internalBinaryWrite(message.request.resourceNameGet, writer.tag(67, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceNameExists") ResourceAPI_Name_Exists_Request.internalBinaryWrite(message.request.resourceNameExists, writer.tag(68, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceNameDelete") ResourceAPI_Name_Delete_Request.internalBinaryWrite(message.request.resourceNameDelete, writer.tag(69, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceTree") ResourceAPI_Tree_Request.internalBinaryWrite(message.request.resourceTree, writer.tag(70, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceTreeSize") ResourceAPI_TreeSize_Request.internalBinaryWrite(message.request.resourceTreeSize, writer.tag(71, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldCreate") FieldAPI_Create_Request.internalBinaryWrite(message.request.fieldCreate, writer.tag(101, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldSet") FieldAPI_Set_Request.internalBinaryWrite(message.request.fieldSet, writer.tag(102, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldGet") FieldAPI_Get_Request.internalBinaryWrite(message.request.fieldGet, writer.tag(103, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldReset") FieldAPI_Reset_Request.internalBinaryWrite(message.request.fieldReset, writer.tag(104, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldSetError") FieldAPI_SetError_Request.internalBinaryWrite(message.request.fieldSetError, writer.tag(105, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldRemove") FieldAPI_Remove_Request.internalBinaryWrite(message.request.fieldRemove, writer.tag(106, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldExists") FieldAPI_Exists_Request.internalBinaryWrite(message.request.fieldExists, writer.tag(107, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "fieldList") FieldAPI_List_Request.internalBinaryWrite(message.request.fieldList, writer.tag(108, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "subscriptionCreate") SubscriptionAPI_CreateSubscription_Request.internalBinaryWrite(message.request.subscriptionCreate, writer.tag(111, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "subscriptionAttachFilter") SubscriptionAPI_AttachFilter_Request.internalBinaryWrite(message.request.subscriptionAttachFilter, writer.tag(112, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "subscriptionDetachFilter") SubscriptionAPI_DetachFilter_Request.internalBinaryWrite(message.request.subscriptionDetachFilter, writer.tag(113, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "subscriptionCreateFilter") SubscriptionAPI_CreateFilter_Request.internalBinaryWrite(message.request.subscriptionCreateFilter, writer.tag(115, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "notificationGet") NotificationAPI_Get_Request.internalBinaryWrite(message.request.notificationGet, writer.tag(154, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "notificationAck") NotificationAPI_Ack_Request.internalBinaryWrite(message.request.notificationAck, writer.tag(155, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "notificationDiscard") NotificationAPI_Discard_Request.internalBinaryWrite(message.request.notificationDiscard, writer.tag(156, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueSet") ResourceKVAPI_Set_Request.internalBinaryWrite(message.request.resourceKeyValueSet, writer.tag(200, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueGet") ResourceKVAPI_Get_Request.internalBinaryWrite(message.request.resourceKeyValueGet, writer.tag(201, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueGetIfExists") ResourceKVAPI_GetIfExists_Request.internalBinaryWrite(message.request.resourceKeyValueGetIfExists, writer.tag(202, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueSetFlag") ResourceKVAPI_SetFlag_Request.internalBinaryWrite(message.request.resourceKeyValueSetFlag, writer.tag(203, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueGetFlag") ResourceKVAPI_GetFlag_Request.internalBinaryWrite(message.request.resourceKeyValueGetFlag, writer.tag(204, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueGetFlagIfExists") ResourceKVAPI_GetFlag_Request.internalBinaryWrite(message.request.resourceKeyValueGetFlagIfExists, writer.tag(205, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueDelete") ResourceKVAPI_Delete_Request.internalBinaryWrite(message.request.resourceKeyValueDelete, writer.tag(206, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "resourceKeyValueList") ResourceKVAPI_List_Request.internalBinaryWrite(message.request.resourceKeyValueList, writer.tag(207, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "controllerKeyValueSet") ControllerKVAPI_Set_Request.internalBinaryWrite(message.request.controllerKeyValueSet, writer.tag(250, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "controllerKeyValueGet") ControllerKVAPI_Get_Request.internalBinaryWrite(message.request.controllerKeyValueGet, writer.tag(251, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "controllerKeyValueGetIfExists") ControllerKVAPI_GetIfExists_Request.internalBinaryWrite(message.request.controllerKeyValueGetIfExists, writer.tag(252, WireType.LengthDelimited).fork(), options).join();
		if (message.request.oneofKind === "controllerKeyValueSetFlag") ControllerKVAPI_SetFlag_Request.internalBinaryWrite(message.request.controllerKeyValueSetFlag, writer.tag(253, WireType.LengthDelimited).fork(), options).join();
...
*/
const TxAPI_ClientMessage = new TxAPI_ClientMessage$Type();
var TxAPI_ServerMessage$Type = class extends MessageType {
	constructor() {
		super("MiLaboratories.PL.API.TxAPI.ServerMessage", [
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_CreateRoot_Response
			},
			{
				no: 57,
				name: "resource_remove",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_CreateStruct_Response
			},
			{
				no: 62,
				name: "resource_create_ephemeral",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_CreateEphemeral_Response
			},
			{
				no: 52,
				name: "resource_create_value",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_CreateValue_Response
			},
			{
				no: 63,
				name: "resource_get_value_id",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_GetValueID_Response
			},
			{
				no: 64,
				name: "resource_create_singleton",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_CreateSingleton_Response
			},
			{
				no: 65,
				name: "resource_get_singleton",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_GetSingleton_Response
			},
			{
				no: 59,
				name: "resource_create_child",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_CreateChild_Response
			},
			{
				no: 53,
				name: "resource_lock_inputs",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_LockInputs_Response
			},
			{
				no: 56,
				name: "resource_lock_outputs",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_LockOutputs_Response
			},
			{
				no: 54,
				name: "resource_exists",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_SetError_Response
			},
			{
				no: 60,
				name: "resource_list_by_type",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_List_ByType_Response
			},
			{
				no: 66,
				name: "resource_name_set",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_Name_Set_Response
			},
			{
				no: 67,
				name: "resource_name_get",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_Name_Get_Response
			},
			{
				no: 68,
				name: "resource_name_exists",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_Name_Exists_Response
			},
			{
				no: 69,
				name: "resource_name_delete",
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_Name_Delete_Response
			},
			{
				no: 70,
				name: "resource_tree",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => ResourceAPI_TreeSize_Response
			},
			{
				no: 101,
				name: "field_create",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => SubscriptionAPI_CreateSubscription_Response
			},
			{
				no: 115,
				name: "subscription_create_filter",
				kind: "message",
				oneof: "response",
				T: () => SubscriptionAPI_CreateFilter_Response
			},
			{
				no: 112,
				name: "subscription_attach_filter",
				kind: "message",
				oneof: "response",
				T: () => SubscriptionAPI_AttachFilter_Response
			},
			{
				no: 113,
				name: "subscription_detach_filter",
				kind: "message",
				oneof: "response",
				T: () => SubscriptionAPI_DetachFilter_Response
			},
			{
				no: 154,
				name: "notification_get",
				kind: "message",
				oneof: "response",
				T: () => NotificationAPI_Get_Response
			},
			{
				no: 155,
				name: "notification_ack",
				kind: "message",
				oneof: "response",
				T: () => NotificationAPI_Ack_Response
			},
			{
				no: 156,
				name: "notification_discard",
				kind: "message",
				oneof: "response",
				T: () => NotificationAPI_Discard_Response
			},
			{
				no: 200,
				name: "resource_key_value_set",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => ResourceKVAPI_GetIfExists_Response
			},
			{
				no: 203,
				name: "resource_key_value_set_flag",
				kind: "message",
				oneof: "response",
				T: () => ResourceKVAPI_SetFlag_Response
			},
			{
				no: 204,
				name: "resource_key_value_get_flag",
				kind: "message",
				oneof: "response",
				T: () => ResourceKVAPI_GetFlag_Response
			},
			{
				no: 205,
				name: "resource_key_value_get_flag_if_exists",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => ResourceKVAPI_Delete_Response
			},
			{
				no: 207,
				name: "resource_key_value_list",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => ControllerKVAPI_Set_Response
			},
			{
				no: 251,
				name: "controller_key_value_get",
				kind: "message",
				oneof: "response",
				T: () => ControllerKVAPI_Get_Response
			},
			{
				no: 252,
				name: "controller_key_value_get_if_exists",
				kind: "message",
				oneof: "response",
				T: () => ControllerKVAPI_GetIfExists_Response
			},
			{
				no: 253,
				name: "controller_key_value_set_flag",
				kind: "message",
				oneof: "response",
				T: () => ControllerKVAPI_SetFlag_Response
			},
			{
				no: 254,
				name: "controller_key_value_get_flag",
				kind: "message",
				oneof: "response",
				T: () => ControllerKVAPI_GetFlag_Response
			},
			{
				no: 255,
				name: "controller_key_value_get_flag_if_exists",
			...
			},
			{
				...
				kind: "message",
				oneof: "response",
				T: () => CacheAPI_SetToField_Response
			},
			{
				no: 301,
				name: "cache_delete_expired_records",
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case 11:
					message.response = {
						oneofKind: "txOpen",
						txOpen: TxAPI_Open_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.txOpen)
					};
					break;
				case 12:
					message.response = {
						oneofKind: "txCommit",
						txCommit: TxAPI_Commit_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.txCommit)
					};
					break;
				case 13:
					message.response = {
				...
				case 58:
					message.response = {
						oneofKind: "resourceCreateRoot",
						resourceCreateRoot: ResourceAPI_CreateRoot_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceCreateRoot)
					};
					break;
				case 57:
					message.response = {
						oneofKind: "resourceRemove",
						resourceRemove: ResourceAPI_Remove_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceRemove)
					};
					break;
				case 51:
					message.response = {
						oneofKind: "resourceCreateStruct",
						resourceCreateStruct: ResourceAPI_CreateStruct_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceCreateStruct)
					};
					break;
				case 62:
					message.response = {
						oneofKind: "resourceCreateEphemeral",
						resourceCreateEphemeral: ResourceAPI_CreateEphemeral_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceCreateEphemeral)
					};
					break;
				case 52:
					message.response = {
						oneofKind: "resourceCreateValue",
						resourceCreateValue: ResourceAPI_CreateValue_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceCreateValue)
					};
					break;
				case 63:
					message.response = {
						oneofKind: "resourceGetValueId",
						resourceGetValueId: ResourceAPI_GetValueID_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceGetValueId)
					};
					break;
				case 64:
					message.response = {
						oneofKind: "resourceCreateSingleton",
						resourceCreateSingleton: ResourceAPI_CreateSingleton_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceCreateSingleton)
					};
					break;
				case 65:
					message.response = {
						oneofKind: "resourceGetSingleton",
						resourceGetSingleton: ResourceAPI_GetSingleton_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceGetSingleton)
					};
					break;
				case 59:
					message.response = {
						oneofKind: "resourceCreateChild",
						resourceCreateChild: ResourceAPI_CreateChild_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceCreateChild)
					};
					break;
				case 53:
					message.response = {
						oneofKind: "resourceLockInputs",
						resourceLockInputs: ResourceAPI_LockInputs_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceLockInputs)
					};
					break;
				case 56:
					message.response = {
						oneofKind: "resourceLockOutputs",
						resourceLockOutputs: ResourceAPI_LockOutputs_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceLockOutputs)
					};
					break;
				case 54:
					message.response = {
						oneofKind: "resourceExists",
						resourceExists: ResourceAPI_Exists_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceExists)
					};
					break;
				case 55:
					message.response = {
						oneofKind: "resourceGet",
						resourceGet: ResourceAPI_Get_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceGet)
					};
					break;
				case 61:
					message.response = {
						oneofKind: "resourceSetError",
						resourceSetError: ResourceAPI_SetError_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceSetError)
					};
					break;
				case 60:
					message.response = {
						oneofKind: "resourceListByType",
						resourceListByType: ResourceAPI_List_ByType_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceListByType)
					};
					break;
				case 66:
					message.response = {
						oneofKind: "resourceNameSet",
						resourceNameSet: ResourceAPI_Name_Set_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceNameSet)
					};
					break;
				case 67:
					message.response = {
						oneofKind: "resourceNameGet",
						resourceNameGet: ResourceAPI_Name_Get_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceNameGet)
					};
					break;
				case 68:
					message.response = {
						oneofKind: "resourceNameExists",
						resourceNameExists: ResourceAPI_Name_Exists_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceNameExists)
					};
					break;
				case 69:
					message.response = {
						oneofKind: "resourceNameDelete",
						resourceNameDelete: ResourceAPI_Name_Delete_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceNameDelete)
					};
					break;
				case 70:
					message.response = {
						oneofKind: "resourceTree",
						resourceTree: ResourceAPI_Tree_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceTree)
					};
					break;
				case 71:
					message.response = {
						oneofKind: "resourceTreeSize",
						resourceTreeSize: ResourceAPI_TreeSize_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceTreeSize)
					};
					break;
				case 101:
					message.response = {
						oneofKind: "fieldCreate",
						fieldCreate: FieldAPI_Create_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldCreate)
					};
					break;
				case 107:
					message.response = {
						oneofKind: "fieldExists",
						fieldExists: FieldAPI_Exists_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldExists)
					};
					break;
				case 102:
					message.response = {
						oneofKind: "fieldSet",
						fieldSet: FieldAPI_Set_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldSet)
					};
					break;
				case 105:
					message.response = {
						oneofKind: "fieldSetError",
						fieldSetError: FieldAPI_SetError_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldSetError)
					};
					break;
				case 103:
					message.response = {
						oneofKind: "fieldGet",
						fieldGet: FieldAPI_Get_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldGet)
					};
					break;
				case 104:
					message.response = {
						oneofKind: "fieldReset",
						fieldReset: FieldAPI_Reset_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldReset)
					};
					break;
				case 106:
					message.response = {
						oneofKind: "fieldRemove",
						fieldRemove: FieldAPI_Remove_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldRemove)
					};
					break;
				case 108:
					message.response = {
						oneofKind: "fieldList",
						fieldList: FieldAPI_List_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.fieldList)
					};
					break;
				case 111:
					message.response = {
						oneofKind: "subscriptionCreate",
						subscriptionCreate: SubscriptionAPI_CreateSubscription_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.subscriptionCreate)
					};
					break;
				case 115:
					message.response = {
						oneofKind: "subscriptionCreateFilter",
						subscriptionCreateFilter: SubscriptionAPI_CreateFilter_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.subscriptionCreateFilter)
					};
					break;
				case 112:
					message.response = {
						oneofKind: "subscriptionAttachFilter",
						subscriptionAttachFilter: SubscriptionAPI_AttachFilter_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.subscriptionAttachFilter)
					};
					break;
				case 113:
					message.response = {
						oneofKind: "subscriptionDetachFilter",
						subscriptionDetachFilter: SubscriptionAPI_DetachFilter_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.subscriptionDetachFilter)
					};
					break;
				case 154:
					message.response = {
						oneofKind: "notificationGet",
						notificationGet: NotificationAPI_Get_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.notificationGet)
					};
					break;
				case 155:
					message.response = {
						oneofKind: "notificationAck",
						notificationAck: NotificationAPI_Ack_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.notificationAck)
					};
					break;
				case 156:
					message.response = {
						oneofKind: "notificationDiscard",
						notificationDiscard: NotificationAPI_Discard_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.notificationDiscard)
					};
					break;
				case 200:
					message.response = {
						oneofKind: "resourceKeyValueSet",
						resourceKeyValueSet: ResourceKVAPI_Set_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueSet)
					};
					break;
				case 201:
					message.response = {
						oneofKind: "resourceKeyValueGet",
						resourceKeyValueGet: ResourceKVAPI_Get_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueGet)
					};
					break;
				case 202:
					message.response = {
						oneofKind: "resourceKeyValueGetIfExists",
						resourceKeyValueGetIfExists: ResourceKVAPI_GetIfExists_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueGetIfExists)
					};
					break;
				case 203:
					message.response = {
						oneofKind: "resourceKeyValueSetFlag",
						resourceKeyValueSetFlag: ResourceKVAPI_SetFlag_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueSetFlag)
					};
					break;
				case 204:
					message.response = {
						oneofKind: "resourceKeyValueGetFlag",
						resourceKeyValueGetFlag: ResourceKVAPI_GetFlag_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueGetFlag)
					};
					break;
				case 205:
					message.response = {
						oneofKind: "resourceKeyValueGetFlagIfExists",
						resourceKeyValueGetFlagIfExists: ResourceKVAPI_GetFlag_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueGetFlagIfExists)
					};
					break;
				case 206:
					message.response = {
						oneofKind: "resourceKeyValueDelete",
						resourceKeyValueDelete: ResourceKVAPI_Delete_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueDelete)
					};
					break;
				case 207:
					message.response = {
						oneofKind: "resourceKeyValueList",
						resourceKeyValueList: ResourceKVAPI_List_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.resourceKeyValueList)
					};
					break;
				case 250:
					message.response = {
						oneofKind: "controllerKeyValueSet",
						controllerKeyValueSet: ControllerKVAPI_Set_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.controllerKeyValueSet)
					};
					break;
				case 251:
					message.response = {
						oneofKind: "controllerKeyValueGet",
						controllerKeyValueGet: ControllerKVAPI_Get_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.controllerKeyValueGet)
					};
					break;
				case 252:
					message.response = {
				...
				case 300:
					message.response = {
						oneofKind: "cacheSetToField",
						cacheSetToField: CacheAPI_SetToField_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.cacheSetToField)
					};
					break;
				case 301:
					message.response = {
				...
				case 350:
					message.response = {
						oneofKind: "controllerFeaturesSet",
						controllerFeaturesSet: ControllerAPI_SetFeatures_Response.internalBinaryRead(reader, reader.uint32(), options, message.response.controllerFeaturesSet)
					};
					break;
				case 351:
					message.response = {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.requestId !== 0) writer.tag(1, WireType.Varint).uint32(message.requestId);
		if (message.multiMessage) TxAPI_ServerMessage_Multi.internalBinaryWrite(message.multiMessage, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		if (message.error) Status.internalBinaryWrite(message.error, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "txOpen") TxAPI_Open_Response.internalBinaryWrite(message.response.txOpen, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "txCommit") TxAPI_Commit_Response.internalBinaryWrite(message.response.txCommit, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "txDiscard") TxAPI_Discard_Response.internalBinaryWrite(message.response.txDiscard, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "streamClose") TxAPI_CloseStream_Response.internalBinaryWrite(message.response.streamClose, writer.tag(14, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceCreateStruct") ResourceAPI_CreateStruct_Response.internalBinaryWrite(message.response.resourceCreateStruct, writer.tag(51, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceCreateValue") ResourceAPI_CreateValue_Response.internalBinaryWrite(message.response.resourceCreateValue, writer.tag(52, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceLockInputs") ResourceAPI_LockInputs_Response.internalBinaryWrite(message.response.resourceLockInputs, writer.tag(53, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceExists") ResourceAPI_Exists_Response.internalBinaryWrite(message.response.resourceExists, writer.tag(54, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceGet") ResourceAPI_Get_Response.internalBinaryWrite(message.response.resourceGet, writer.tag(55, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceLockOutputs") ResourceAPI_LockOutputs_Response.internalBinaryWrite(message.response.resourceLockOutputs, writer.tag(56, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceRemove") ResourceAPI_Remove_Response.internalBinaryWrite(message.response.resourceRemove, writer.tag(57, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceCreateRoot") ResourceAPI_CreateRoot_Response.internalBinaryWrite(message.response.resourceCreateRoot, writer.tag(58, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceCreateChild") ResourceAPI_CreateChild_Response.internalBinaryWrite(message.response.resourceCreateChild, writer.tag(59, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceListByType") ResourceAPI_List_ByType_Response.internalBinaryWrite(message.response.resourceListByType, writer.tag(60, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceSetError") ResourceAPI_SetError_Response.internalBinaryWrite(message.response.resourceSetError, writer.tag(61, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceCreateEphemeral") ResourceAPI_CreateEphemeral_Response.internalBinaryWrite(message.response.resourceCreateEphemeral, writer.tag(62, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceGetValueId") ResourceAPI_GetValueID_Response.internalBinaryWrite(message.response.resourceGetValueId, writer.tag(63, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceCreateSingleton") ResourceAPI_CreateSingleton_Response.internalBinaryWrite(message.response.resourceCreateSingleton, writer.tag(64, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceGetSingleton") ResourceAPI_GetSingleton_Response.internalBinaryWrite(message.response.resourceGetSingleton, writer.tag(65, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceNameSet") ResourceAPI_Name_Set_Response.internalBinaryWrite(message.response.resourceNameSet, writer.tag(66, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceNameGet") ResourceAPI_Name_Get_Response.internalBinaryWrite(message.response.resourceNameGet, writer.tag(67, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceNameExists") ResourceAPI_Name_Exists_Response.internalBinaryWrite(message.response.resourceNameExists, writer.tag(68, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceNameDelete") ResourceAPI_Name_Delete_Response.internalBinaryWrite(message.response.resourceNameDelete, writer.tag(69, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceTree") ResourceAPI_Tree_Response.internalBinaryWrite(message.response.resourceTree, writer.tag(70, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceTreeSize") ResourceAPI_TreeSize_Response.internalBinaryWrite(message.response.resourceTreeSize, writer.tag(71, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldCreate") FieldAPI_Create_Response.internalBinaryWrite(message.response.fieldCreate, writer.tag(101, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldSet") FieldAPI_Set_Response.internalBinaryWrite(message.response.fieldSet, writer.tag(102, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldGet") FieldAPI_Get_Response.internalBinaryWrite(message.response.fieldGet, writer.tag(103, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldReset") FieldAPI_Reset_Response.internalBinaryWrite(message.response.fieldReset, writer.tag(104, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldSetError") FieldAPI_SetError_Response.internalBinaryWrite(message.response.fieldSetError, writer.tag(105, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldRemove") FieldAPI_Remove_Response.internalBinaryWrite(message.response.fieldRemove, writer.tag(106, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldExists") FieldAPI_Exists_Response.internalBinaryWrite(message.response.fieldExists, writer.tag(107, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "fieldList") FieldAPI_List_Response.internalBinaryWrite(message.response.fieldList, writer.tag(108, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "subscriptionCreate") SubscriptionAPI_CreateSubscription_Response.internalBinaryWrite(message.response.subscriptionCreate, writer.tag(111, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "subscriptionAttachFilter") SubscriptionAPI_AttachFilter_Response.internalBinaryWrite(message.response.subscriptionAttachFilter, writer.tag(112, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "subscriptionDetachFilter") SubscriptionAPI_DetachFilter_Response.internalBinaryWrite(message.response.subscriptionDetachFilter, writer.tag(113, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "subscriptionCreateFilter") SubscriptionAPI_CreateFilter_Response.internalBinaryWrite(message.response.subscriptionCreateFilter, writer.tag(115, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "notificationGet") NotificationAPI_Get_Response.internalBinaryWrite(message.response.notificationGet, writer.tag(154, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "notificationAck") NotificationAPI_Ack_Response.internalBinaryWrite(message.response.notificationAck, writer.tag(155, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "notificationDiscard") NotificationAPI_Discard_Response.internalBinaryWrite(message.response.notificationDiscard, writer.tag(156, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueSet") ResourceKVAPI_Set_Response.internalBinaryWrite(message.response.resourceKeyValueSet, writer.tag(200, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueGet") ResourceKVAPI_Get_Response.internalBinaryWrite(message.response.resourceKeyValueGet, writer.tag(201, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueGetIfExists") ResourceKVAPI_GetIfExists_Response.internalBinaryWrite(message.response.resourceKeyValueGetIfExists, writer.tag(202, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueSetFlag") ResourceKVAPI_SetFlag_Response.internalBinaryWrite(message.response.resourceKeyValueSetFlag, writer.tag(203, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueGetFlag") ResourceKVAPI_GetFlag_Response.internalBinaryWrite(message.response.resourceKeyValueGetFlag, writer.tag(204, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueGetFlagIfExists") ResourceKVAPI_GetFlag_Response.internalBinaryWrite(message.response.resourceKeyValueGetFlagIfExists, writer.tag(205, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueDelete") ResourceKVAPI_Delete_Response.internalBinaryWrite(message.response.resourceKeyValueDelete, writer.tag(206, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "resourceKeyValueList") ResourceKVAPI_List_Response.internalBinaryWrite(message.response.resourceKeyValueList, writer.tag(207, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "controllerKeyValueSet") ControllerKVAPI_Set_Response.internalBinaryWrite(message.response.controllerKeyValueSet, writer.tag(250, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "controllerKeyValueGet") ControllerKVAPI_Get_Response.internalBinaryWrite(message.response.controllerKeyValueGet, writer.tag(251, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "controllerKeyValueGetIfExists") ControllerKVAPI_GetIfExists_Response.internalBinaryWrite(message.response.controllerKeyValueGetIfExists, writer.tag(252, WireType.LengthDelimited).fork(), options).join();
		if (message.response.oneofKind === "controllerKeyValueSetFlag") ControllerKVAPI_SetFlag_Response.internalBinaryWrite(message.response.controllerKeyValueSetFlag, writer.tag(253, WireType.LengthDelimited).fork(), options).join();
...
*/
const TxAPI_ServerMessage = new TxAPI_ServerMessage$Type();
var TxAPI_ServerMessage_Multi$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.isLast !== false) writer.tag(2, WireType.Varint).bool(message.isLast);
		if (message.isEmpty !== false) writer.tag(3, WireType.Varint).bool(message.isEmpty);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const TxAPI_ServerMessage_Multi = new TxAPI_ServerMessage_Multi$Type();
var TxAPI_Open$Type = class extends MessageType {
	constructor() {
...
var TxAPI_Open_Request$Type = class extends MessageType {
	constructor() {
		super("MiLaboratories.PL.API.TxAPI.Open.Request", [
			...
			},
			{
				...
				name: "writable",
				kind: "enum",
				T: () => ["MiLaboratories.PL.API.TxAPI.Open.Request.WritableTx", TxAPI_Open_Request_WritableTx]
			},
			{
				no: 3,
				name: "enableFormattedErrors",
				kind: "scalar",
				T: 8
			}
		]);
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.writable !== 0) writer.tag(2, WireType.Varint).int32(message.writable);
		if (message.enableFormattedErrors !== false) writer.tag(3, WireType.Varint).bool(message.enableFormattedErrors);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const TxAPI_Open_Request = new TxAPI_Open_Request$Type();
var TxAPI_Open_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.tx) Tx.internalBinaryWrite(message.tx, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const TxAPI_Open_Response = new TxAPI_Open_Response$Type();
var TxAPI_Commit$Type = class extends MessageType {
	constructor() {
...
*/
const TxAPI_Commit_Request = new TxAPI_Commit_Request$Type();
var TxAPI_Commit_Response$Type = class extends MessageType {
	constructor() {
...
*/
const TxAPI_Commit_Response = new TxAPI_Commit_Response$Type();
var TxAPI_Discard$Type = class extends MessageType {
	constructor() {
...
*/
const TxAPI_Discard_Request = new TxAPI_Discard_Request$Type();
var TxAPI_Discard_Response$Type = class extends MessageType {
	constructor() {
...
var TxAPI_CloseStream$Type = class extends MessageType {
	constructor() {
...
var TxAPI_CloseStream_Response$Type = class extends MessageType {
	constructor() {
...
var TxAPI_Sync$Type = class extends MessageType {
	constructor() {
...
var TxAPI_Sync_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.txId !== 0n) writer.tag(1, WireType.Varint).uint64(message.txId);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const TxAPI_Sync_Request = new TxAPI_Sync_Request$Type();
var TxAPI_Sync_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateStruct_Request = new ResourceAPI_CreateStruct_Request$Type();
var ResourceAPI_CreateStruct_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateStruct_Response = new ResourceAPI_CreateStruct_Response$Type();
var ResourceAPI_CreateEphemeral$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateEphemeral_Request = new ResourceAPI_CreateEphemeral_Request$Type();
var ResourceAPI_CreateEphemeral_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateEphemeral_Response = new ResourceAPI_CreateEphemeral_Response$Type();
var ResourceAPI_CreateChild$Type = class extends MessageType {
	constructor() {
...
var ResourceAPI_CreateChild_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.type) ResourceType.internalBinaryWrite(message.type, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		if (message.parentField) FieldRef.internalBinaryWrite(message.parentField, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceAPI_CreateChild_Request = new ResourceAPI_CreateChild_Request$Type();
var ResourceAPI_CreateChild_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateChild_Response = new ResourceAPI_CreateChild_Response$Type();
var ResourceAPI_CreateValue$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateValue_Request = new ResourceAPI_CreateValue_Request$Type();
var ResourceAPI_CreateValue_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateValue_Response = new ResourceAPI_CreateValue_Response$Type();
var ResourceAPI_GetValueID$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_GetValueID_Request = new ResourceAPI_GetValueID_Request$Type();
var ResourceAPI_GetValueID_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_GetValueID_Response = new ResourceAPI_GetValueID_Response$Type();
var ResourceAPI_CreateSingleton$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateSingleton_Request = new ResourceAPI_CreateSingleton_Request$Type();
var ResourceAPI_CreateSingleton_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateSingleton_Response = new ResourceAPI_CreateSingleton_Response$Type();
var ResourceAPI_GetSingleton$Type = class extends MessageType {
	constructor() {
...
var ResourceAPI_GetSingleton_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.type) ResourceType.internalBinaryWrite(message.type, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		if (message.data.length) writer.tag(2, WireType.LengthDelimited).bytes(message.data);
		if (message.loadFields !== false) writer.tag(3, WireType.Varint).bool(message.loadFields);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceAPI_GetSingleton_Request = new ResourceAPI_GetSingleton_Request$Type();
var ResourceAPI_GetSingleton_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.resource) Resource.internalBinaryWrite(message.resource, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceAPI_GetSingleton_Response = new ResourceAPI_GetSingleton_Response$Type();
var ResourceAPI_LockInputs$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_LockInputs_Request = new ResourceAPI_LockInputs_Request$Type();
var ResourceAPI_LockInputs_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_LockInputs_Response = new ResourceAPI_LockInputs_Response$Type();
var ResourceAPI_LockOutputs$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_LockOutputs_Request = new ResourceAPI_LockOutputs_Request$Type();
var ResourceAPI_LockOutputs_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_LockOutputs_Response = new ResourceAPI_LockOutputs_Response$Type();
var ResourceAPI_Exists$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Exists_Request = new ResourceAPI_Exists_Request$Type();
var ResourceAPI_Exists_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.exists !== false) writer.tag(1, WireType.Varint).bool(message.exists);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceAPI_Exists_Response = new ResourceAPI_Exists_Response$Type();
var ResourceAPI_SetError$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_SetError_Request = new ResourceAPI_SetError_Request$Type();
var ResourceAPI_SetError_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_SetError_Response = new ResourceAPI_SetError_Response$Type();
var ResourceAPI_Get$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Get_Request = new ResourceAPI_Get_Request$Type();
var ResourceAPI_Get_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Get_Response = new ResourceAPI_Get_Response$Type();
var ResourceAPI_List$Type = class extends MessageType {
	constructor() {
...
var ResourceAPI_List_ByType_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.resourceType) ResourceType.internalBinaryWrite(message.resourceType, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		if (message.limit !== 0) writer.tag(3, WireType.Varint).uint32(message.limit);
		if (message.resolveDuplicates !== false) writer.tag(4, WireType.Varint).bool(message.resolveDuplicates);
		if (message.loadFields !== false) writer.tag(5, WireType.Varint).bool(message.loadFields);
		if (message.after !== 0n) writer.tag(6, WireType.Varint).uint64(message.after);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceAPI_List_ByType_Request = new ResourceAPI_List_ByType_Request$Type();
var ResourceAPI_List_ByType_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_List_ByType_Response = new ResourceAPI_List_ByType_Response$Type();
var ResourceAPI_CreateRoot$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateRoot_Request = new ResourceAPI_CreateRoot_Request$Type();
var ResourceAPI_CreateRoot_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_CreateRoot_Response = new ResourceAPI_CreateRoot_Response$Type();
var ResourceAPI_Remove$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Remove_Request = new ResourceAPI_Remove_Request$Type();
var ResourceAPI_Remove_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Remove_Response = new ResourceAPI_Remove_Response$Type();
var ResourceAPI_Name$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Set_Request = new ResourceAPI_Name_Set_Request$Type();
var ResourceAPI_Name_Set_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Set_Response = new ResourceAPI_Name_Set_Response$Type();
var ResourceAPI_Name_Get$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Get_Request = new ResourceAPI_Name_Get_Request$Type();
var ResourceAPI_Name_Get_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Get_Response = new ResourceAPI_Name_Get_Response$Type();
var ResourceAPI_Name_Exists$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Exists_Request = new ResourceAPI_Name_Exists_Request$Type();
var ResourceAPI_Name_Exists_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Exists_Response = new ResourceAPI_Name_Exists_Response$Type();
var ResourceAPI_Name_Delete$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Delete_Request = new ResourceAPI_Name_Delete_Request$Type();
var ResourceAPI_Name_Delete_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Name_Delete_Response = new ResourceAPI_Name_Delete_Response$Type();
var ResourceAPI_Tree$Type = class extends MessageType {
	constructor() {
...
var ResourceAPI_Tree_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_Tree_Response = new ResourceAPI_Tree_Response$Type();
var ResourceAPI_TreeSize$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceAPI_TreeSize_Request = new ResourceAPI_TreeSize_Request$Type();
var ResourceAPI_TreeSize_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.size !== 0n) writer.tag(1, WireType.Varint).uint64(message.size);
		if (message.resourceCount !== 0n) writer.tag(2, WireType.Varint).uint64(message.resourceCount);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceAPI_TreeSize_Response = new ResourceAPI_TreeSize_Response$Type();
var FieldAPI$Type = class extends MessageType {
	constructor() {
...
var FieldAPI_Create_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.id) FieldRef.internalBinaryWrite(message.id, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const FieldAPI_Create_Request = new FieldAPI_Create_Request$Type();
var FieldAPI_Create_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.globalId) FieldRef.internalBinaryWrite(message.globalId, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const FieldAPI_Create_Response = new FieldAPI_Create_Response$Type();
var FieldAPI_Exists$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Exists_Request = new FieldAPI_Exists_Request$Type();
var FieldAPI_Exists_Response$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Exists_Response = new FieldAPI_Exists_Response$Type();
var FieldAPI_Set$Type = class extends MessageType {
	constructor() {
...
var FieldAPI_Set_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.field) FieldRef.internalBinaryWrite(message.field, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		if (message.value) FieldRef.internalBinaryWrite(message.value, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const FieldAPI_Set_Request = new FieldAPI_Set_Request$Type();
var FieldAPI_Set_Response$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Set_Response = new FieldAPI_Set_Response$Type();
var FieldAPI_SetError$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_SetError_Request = new FieldAPI_SetError_Request$Type();
var FieldAPI_SetError_Response$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_SetError_Response = new FieldAPI_SetError_Response$Type();
var FieldAPI_Get$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Get_Request = new FieldAPI_Get_Request$Type();
var FieldAPI_Get_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.field) Field.internalBinaryWrite(message.field, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const FieldAPI_Get_Response = new FieldAPI_Get_Response$Type();
var FieldAPI_Reset$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Reset_Request = new FieldAPI_Reset_Request$Type();
var FieldAPI_Reset_Response$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Reset_Response = new FieldAPI_Reset_Response$Type();
var FieldAPI_Remove$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Remove_Request = new FieldAPI_Remove_Request$Type();
var FieldAPI_Remove_Response$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_Remove_Response = new FieldAPI_Remove_Response$Type();
var FieldAPI_List$Type = class extends MessageType {
	constructor() {
...
*/
const FieldAPI_List_Request = new FieldAPI_List_Request$Type();
var FieldAPI_List_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.field) Field.internalBinaryWrite(message.field, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		if (message.next !== "") writer.tag(4, WireType.LengthDelimited).string(message.next);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const FieldAPI_List_Response = new FieldAPI_List_Response$Type();
var NotificationAPI$Type = class extends MessageType {
	constructor() {
...
var NotificationAPI_Get_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.subscription !== 0n) writer.tag(1, WireType.Varint).uint64(message.subscription);
		if (message.maxNotifications !== 0) writer.tag(2, WireType.Varint).uint32(message.maxNotifications);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const NotificationAPI_Get_Request = new NotificationAPI_Get_Request$Type();
var NotificationAPI_Get_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		for (let i = 0; i < message.notifications.length; i++) Notification.internalBinaryWrite(message.notifications[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const NotificationAPI_Get_Response = new NotificationAPI_Get_Response$Type();
var NotificationAPI_Ack$Type = class extends MessageType {
	constructor() {
...
*/
const NotificationAPI_Ack_Request = new NotificationAPI_Ack_Request$Type();
var NotificationAPI_Ack_Response$Type = class extends MessageType {
	constructor() {
...
*/
const NotificationAPI_Ack_Response = new NotificationAPI_Ack_Response$Type();
var NotificationAPI_Discard$Type = class extends MessageType {
	constructor() {
...
*/
const NotificationAPI_Discard_Request = new NotificationAPI_Discard_Request$Type();
var NotificationAPI_Discard_Response$Type = class extends MessageType {
	constructor() {
...
*/
const NotificationAPI_Discard_Response = new NotificationAPI_Discard_Response$Type();
var SubscriptionAPI$Type = class extends MessageType {
	constructor() {
...
var SubscriptionAPI_CreateSubscription_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.id !== 0n) writer.tag(1, WireType.Varint).uint64(message.id);
		if (message.blocking !== false) writer.tag(2, WireType.Varint).bool(message.blocking);
		if (message.gc !== false) writer.tag(3, WireType.Varint).bool(message.gc);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const SubscriptionAPI_CreateSubscription_Request = new SubscriptionAPI_CreateSubscription_Request$Type();
var SubscriptionAPI_CreateSubscription_Response$Type = class extends MessageType {
	constructor() {
...
*/
const SubscriptionAPI_CreateSubscription_Response = new SubscriptionAPI_CreateSubscription_Response$Type();
var SubscriptionAPI_CreateFilter$Type = class extends MessageType {
	constructor() {
...
var SubscriptionAPI_CreateFilter_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.id !== 0n) writer.tag(1, WireType.Varint).uint64(message.id);
		if (message.filter) NotificationFilter.internalBinaryWrite(message.filter, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const SubscriptionAPI_CreateFilter_Request = new SubscriptionAPI_CreateFilter_Request$Type();
var SubscriptionAPI_CreateFilter_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.filterId !== 0n) writer.tag(1, WireType.Varint).uint64(message.filterId);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const SubscriptionAPI_CreateFilter_Response = new SubscriptionAPI_CreateFilter_Response$Type();
var SubscriptionAPI_ListSubscriptions$Type = class extends MessageType {
	constructor() {
...
var SubscriptionAPI_ListSubscriptions_SubscriptionInfo$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.subscription) Subscription.internalBinaryWrite(message.subscription, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		if (message.lastReadTime !== 0n) writer.tag(2, WireType.Varint).uint64(message.lastReadTime);
		if (message.notificationQueueSize !== 0n) writer.tag(3, WireType.Varint).uint64(message.notificationQueueSize);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const SubscriptionAPI_ListSubscriptions_SubscriptionInfo = new SubscriptionAPI_ListSubscriptions_SubscriptionInfo$Type();
var SubscriptionAPI_ListSubscriptions_Request$Type = class extends MessageType {
	constructor() {
...
var SubscriptionAPI_ListSubscriptions_Response$Type = class extends MessageType {
	constructor() {
		super("MiLaboratories.PL.API.SubscriptionAPI.ListSubscriptions.Response", [{
			...
			kind: "message",
			repeat: 2,
			T: () => SubscriptionAPI_ListSubscriptions_SubscriptionInfo
		}]);
	}
	create(value) {
		const message = globalThis.Object.create(this.messagePrototype);
	...
	internalBinaryWrite(message, writer, options) {
		for (let i = 0; i < message.subscriptions.length; i++) SubscriptionAPI_ListSubscriptions_SubscriptionInfo.internalBinaryWrite(message.subscriptions[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
var SubscriptionAPI_AttachFilter_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.subscriptionId !== 0n) writer.tag(1, WireType.Varint).uint64(message.subscriptionId);
		if (message.filterName !== "") writer.tag(2, WireType.LengthDelimited).string(message.filterName);
		if (message.filterId !== 0n) writer.tag(3, WireType.Varint).uint64(message.filterId);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const SubscriptionAPI_AttachFilter_Request = new SubscriptionAPI_AttachFilter_Request$Type();
var SubscriptionAPI_AttachFilter_Response$Type = class extends MessageType {
	constructor() {
...
*/
const SubscriptionAPI_AttachFilter_Response = new SubscriptionAPI_AttachFilter_Response$Type();
var SubscriptionAPI_DetachFilter$Type = class extends MessageType {
	constructor() {
...
*/
const SubscriptionAPI_DetachFilter_Request = new SubscriptionAPI_DetachFilter_Request$Type();
var SubscriptionAPI_DetachFilter_Response$Type = class extends MessageType {
	constructor() {
...
*/
const SubscriptionAPI_DetachFilter_Response = new SubscriptionAPI_DetachFilter_Response$Type();
var ControllerAPI$Type = class extends MessageType {
	constructor() {
...
var ControllerAPI_Register_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		...
		for (let i = 0; i < message.resourceSchemas.length; i++) ResourceSchema.internalBinaryWrite(message.resourceSchemas[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ControllerAPI_Register_Request = new ControllerAPI_Register_Request$Type();
var ControllerAPI_Register_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.controllerId !== 0n) writer.tag(1, WireType.Varint).uint64(message.controllerId);
		if (message.subscriptionId !== 0n) writer.tag(2, WireType.Varint).uint64(message.subscriptionId);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ControllerAPI_Register_Response = new ControllerAPI_Register_Response$Type();
var ControllerAPI_Exists$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Exists_Request = new ControllerAPI_Exists_Request$Type();
var ControllerAPI_Exists_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Exists_Response = new ControllerAPI_Exists_Response$Type();
var ControllerAPI_Update$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Update_Request = new ControllerAPI_Update_Request$Type();
var ControllerAPI_Update_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Update_Response = new ControllerAPI_Update_Response$Type();
var ControllerAPI_Deregister$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Deregister_Request = new ControllerAPI_Deregister_Request$Type();
var ControllerAPI_Deregister_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Deregister_Response = new ControllerAPI_Deregister_Response$Type();
var ControllerAPI_Create$Type = class extends MessageType {
	constructor() {
...
var ControllerAPI_Create_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.id !== 0n) writer.tag(1, WireType.Varint).uint64(message.id);
		if (message.controllerType !== "") writer.tag(2, WireType.LengthDelimited).string(message.controllerType);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ControllerAPI_Create_Request = new ControllerAPI_Create_Request$Type();
var ControllerAPI_Create_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Create_Response = new ControllerAPI_Create_Response$Type();
var ControllerAPI_Get$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_Get_Request = new ControllerAPI_Get_Request$Type();
var ControllerAPI_Get_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.controller) Controller.internalBinaryWrite(message.controller, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ControllerAPI_Get_Response = new ControllerAPI_Get_Response$Type();
var ControllerAPI_AttachSubscription$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_AttachSubscription_Request = new ControllerAPI_AttachSubscription_Request$Type();
var ControllerAPI_AttachSubscription_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_AttachSubscription_Response = new ControllerAPI_AttachSubscription_Response$Type();
var ControllerAPI_GetNotifications$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_GetNotifications_Request = new ControllerAPI_GetNotifications_Request$Type();
var ControllerAPI_GetNotifications_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_GetNotifications_Response = new ControllerAPI_GetNotifications_Response$Type();
var ControllerAPI_WriteAliasesAndUrls$Type = class extends MessageType {
	constructor() {
...
var ControllerAPI_WriteAliasesAndUrls_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.controllerType !== "") writer.tag(1, WireType.LengthDelimited).string(message.controllerType);
		for (let k of globalThis.Object.keys(message.aliasesToUrls)) writer.tag(2, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.LengthDelimited).string(message.aliasesToUrls[k]).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ControllerAPI_WriteAliasesAndUrls_Request = new ControllerAPI_WriteAliasesAndUrls_Request$Type();
var ControllerAPI_WriteAliasesAndUrls_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_WriteAliasesAndUrls_Response = new ControllerAPI_WriteAliasesAndUrls_Response$Type();
var ControllerAPI_GetUrl$Type = class extends MessageType {
	constructor() {
...
var ControllerAPI_GetUrl_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.controllerAlias !== "") writer.tag(1, WireType.LengthDelimited).string(message.controllerAlias);
...
*/
const ControllerAPI_GetUrl_Request = new ControllerAPI_GetUrl_Request$Type();
var ControllerAPI_GetUrl_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.controllerUrl !== "") writer.tag(2, WireType.LengthDelimited).string(message.controllerUrl);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ControllerAPI_GetUrl_Response = new ControllerAPI_GetUrl_Response$Type();
var ControllerAPI_RemoveAliasesAndUrls$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_RemoveAliasesAndUrls_Request = new ControllerAPI_RemoveAliasesAndUrls_Request$Type();
var ControllerAPI_RemoveAliasesAndUrls_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_RemoveAliasesAndUrls_Response = new ControllerAPI_RemoveAliasesAndUrls_Response$Type();
var ControllerAPI_SetFeatures$Type = class extends MessageType {
	constructor() {
...
var ControllerAPI_SetFeatures_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		for (let i = 0; i < message.features.length; i++) ResourceAPIFeature.internalBinaryWrite(message.features[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ControllerAPI_SetFeatures_Request = new ControllerAPI_SetFeatures_Request$Type();
var ControllerAPI_SetFeatures_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_SetFeatures_Response = new ControllerAPI_SetFeatures_Response$Type();
var ControllerAPI_ClearFeatures$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_ClearFeatures_Request = new ControllerAPI_ClearFeatures_Request$Type();
var ControllerAPI_ClearFeatures_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerAPI_ClearFeatures_Response = new ControllerAPI_ClearFeatures_Response$Type();
var ResourceKVAPI$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_List_Request = new ResourceKVAPI_List_Request$Type();
var ResourceKVAPI_List_Response$Type = class extends MessageType {
	constructor() {
		super("MiLaboratories.PL.API.ResourceKVAPI.List.Response", [{
			no: 1,
			name: "record",
			kind: "message",
			T: () => ResourceKVAPI_List_Response_KV
		}, {
			no: 4,
			name: "next",
			kind: "scalar",
	...
	internalBinaryWrite(message, writer, options) {
		if (message.record) ResourceKVAPI_List_Response_KV.internalBinaryWrite(message.record, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		if (message.next !== "") writer.tag(4, WireType.LengthDelimited).string(message.next);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
...
*/
const ResourceKVAPI_List_Response = new ResourceKVAPI_List_Response$Type();
var ResourceKVAPI_List_Response_KV$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_List_Response_KV = new ResourceKVAPI_List_Response_KV$Type();
var ResourceKVAPI_Set$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_Set_Request = new ResourceKVAPI_Set_Request$Type();
var ResourceKVAPI_Set_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_Set_Response = new ResourceKVAPI_Set_Response$Type();
var ResourceKVAPI_Get$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_Get_Request = new ResourceKVAPI_Get_Request$Type();
var ResourceKVAPI_Get_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.value.length) writer.tag(1, WireType.LengthDelimited).bytes(message.value);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceKVAPI_Get_Response = new ResourceKVAPI_Get_Response$Type();
var ResourceKVAPI_GetIfExists$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_GetIfExists_Request = new ResourceKVAPI_GetIfExists_Request$Type();
var ResourceKVAPI_GetIfExists_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.value.length) writer.tag(1, WireType.LengthDelimited).bytes(message.value);
		if (message.exists !== false) writer.tag(2, WireType.Varint).bool(message.exists);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceKVAPI_GetIfExists_Response = new ResourceKVAPI_GetIfExists_Response$Type();
var ResourceKVAPI_Delete$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_Delete_Request = new ResourceKVAPI_Delete_Request$Type();
var ResourceKVAPI_Delete_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_Delete_Response = new ResourceKVAPI_Delete_Response$Type();
var ResourceKVAPI_SetFlag$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_SetFlag_Request = new ResourceKVAPI_SetFlag_Request$Type();
var ResourceKVAPI_SetFlag_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_SetFlag_Response = new ResourceKVAPI_SetFlag_Response$Type();
var ResourceKVAPI_GetFlag$Type = class extends MessageType {
	constructor() {
...
*/
const ResourceKVAPI_GetFlag_Request = new ResourceKVAPI_GetFlag_Request$Type();
var ResourceKVAPI_GetFlag_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.value !== false) writer.tag(1, WireType.Varint).bool(message.value);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const ResourceKVAPI_GetFlag_Response = new ResourceKVAPI_GetFlag_Response$Type();
var ControllerKVAPI$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerKVAPI_Set_Request = new ControllerKVAPI_Set_Request$Type();
var ControllerKVAPI_Set_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerKVAPI_Set_Response = new ControllerKVAPI_Set_Response$Type();
var ControllerKVAPI_Get$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerKVAPI_Get_Request = new ControllerKVAPI_Get_Request$Type();
var ControllerKVAPI_Get_Response$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerKVAPI_Get_Response = new ControllerKVAPI_Get_Response$Type();
var ControllerKVAPI_GetIfExists$Type = class extends MessageType {
	constructor() {
...
*/
const ControllerKVAPI_GetIfExists_Request = new ControllerKVAPI_GetIfExists_Request$Type();
var ControllerKVAPI_GetIfExists_Response$Type = class extends MessageType {
	constructor() {
...
var ControllerKVAPI_SetFlag$Type = class extends MessageType {
	constructor() {
...
var ControllerKVAPI_SetFlag_Response$Type = class extends MessageType {
	constructor() {
...
var ControllerKVAPI_GetFlag$Type = class extends MessageType {
	constructor() {
...
var ControllerKVAPI_GetFlag_Response$Type = class extends MessageType {
	constructor() {
...
var ControllerKVAPI_GetFlagIfExists$Type = class extends MessageType {
	constructor() {
...
var ControllerKVAPI_GetFlagIfExists_Response$Type = class extends MessageType {
	constructor() {
...
var CacheAPI$Type = class extends MessageType {
	constructor() {
...
var CacheAPI_SetToField_Request$Type = class extends MessageType {
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.period) Duration.internalBinaryWrite(message.period, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
var CacheAPI_SetToField_Response$Type = class extends MessageType {
	constructor() {
...
var LocksAPI_Lease_Create_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		if (message.leaseId.length) writer.tag(1, WireType.LengthDelimited).bytes(message.leaseId);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
var LocksAPI_Lease_Update$Type = class extends MessageType {
	constructor() {
...
*/
const LocksAPI_Lease_Update_Request = new LocksAPI_Lease_Update_Request$Type();
var LocksAPI_Lease_Update_Response$Type = class extends MessageType {
	constructor() {
...
*/
const LocksAPI_Lease_Update_Response = new LocksAPI_Lease_Update_Response$Type();
var LocksAPI_Lease_Release$Type = class extends MessageType {
	constructor() {
...
*/
const LocksAPI_Lease_Release_Request = new LocksAPI_Lease_Release_Request$Type();
var LocksAPI_Lease_Release_Response$Type = class extends MessageType {
	constructor() {
...
*/
const LocksAPI_Lease_Release_Response = new LocksAPI_Lease_Release_Response$Type();
var AuthAPI$Type = class extends MessageType {
	constructor() {
...
*/
const MiscAPI_ListResourceTypes_Request = new MiscAPI_ListResourceTypes_Request$Type();
var MiscAPI_ListResourceTypes_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		for (let i = 0; i < message.types.length; i++) ResourceType.internalBinaryWrite(message.types[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const MiscAPI_ListResourceTypes_Response = new MiscAPI_ListResourceTypes_Response$Type();
var MaintenanceAPI$Type = class extends MessageType {
	constructor() {
...
*/
const MaintenanceAPI_Ping_Request = new MaintenanceAPI_Ping_Request$Type();
var MaintenanceAPI_Ping_Response$Type = class extends MessageType {
	constructor() {
		super("MiLaboratories.PL.API.MaintenanceAPI.Ping.Response", [
			...
			},
			{
				...
				name: "compression",
				kind: "enum",
				T: () => ["MiLaboratories.PL.API.MaintenanceAPI.Ping.Response.Compression", MaintenanceAPI_Ping_Response_Compression]
			},
			{
				no: 5,
				name: "instance_id",
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.os !== "") writer.tag(7, WireType.LengthDelimited).string(message.os);
		if (message.arch !== "") writer.tag(8, WireType.LengthDelimited).string(message.arch);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
var MaintenanceAPI_License$Type = class extends MessageType {
	constructor() {
...
var MaintenanceAPI_License_Response$Type = class extends MessageType {
	constructor() {
	...
	internalBinaryWrite(message, writer, options) {
		...
		if (message.isOk !== false) writer.tag(2, WireType.Varint).bool(message.isOk);
		if (message.responseBody.length) writer.tag(3, WireType.LengthDelimited).bytes(message.responseBody);
		let u = options.writeUnknownFields;
		if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
		return writer;
	}
...
*/
const Platform = new ServiceType("MiLaboratories.PL.API.Platform", [
	{
		name: "Tx",
		serverStreaming: true,
		clientStreaming: true,
		options: {},
		I: TxAPI_ClientMessage,
		O: TxAPI_ServerMessage
	},
	{
		name: "TxSync",
		...
		I: TxAPI_Sync_Request,
		O: TxAPI_Sync_Response
	},
	{
		name: "SubscriptionAttachFilter",
		options: { "google.api.http": {
			post: "/v1/subscription/attach-filter",
			body: "*"
		} },
		I: SubscriptionAPI_AttachFilter_Request,
		O: SubscriptionAPI_AttachFilter_Response
	},
	{
		name: "SubscriptionDetachFilter",
		options: { "google.api.http": {
			post: "/v1/subscription/detach-filter",
			body: "*"
		} },
		I: SubscriptionAPI_DetachFilter_Request,
		O: SubscriptionAPI_DetachFilter_Response
	},
	{
		...
		I: NotificationAPI_Get_Request,
		O: NotificationAPI_Get_Response
	},
	{
		...
		I: ControllerAPI_Register_Request,
		O: ControllerAPI_Register_Response
	},
	{
		name: "ControllerDeregister",
		options: { "google.api.http": {
			post: "/v1/controller/deregister",
			body: "*"
		} },
		I: ControllerAPI_Deregister_Request,
		O: ControllerAPI_Deregister_Response
	},
	{
		...
		I: ControllerAPI_Create_Request,
		O: ControllerAPI_Create_Response
	},
	{
		...
		I: ControllerAPI_Exists_Request,
		O: ControllerAPI_Exists_Response
	},
	{
		name: "ControllerGet",
		options: { "google.api.http": {
		...
		I: ControllerAPI_Get_Request,
		O: ControllerAPI_Get_Response
	},
	{
		...
		I: ControllerAPI_Update_Request,
		O: ControllerAPI_Update_Response
	},
	{
		name: "ControllerAttachSubscription",
		options: { "google.api.http": {
			post: "/v1/controller/attach-subscription",
			body: "*"
		} },
		I: ControllerAPI_AttachSubscription_Request,
		O: ControllerAPI_AttachSubscription_Response
	},
	{
		name: "GetControllerNotifications",
		options: { "google.api.http": {
			post: "/v1/controller/notifications",
			body: "*"
		} },
		I: ControllerAPI_GetNotifications_Request,
		O: ControllerAPI_GetNotifications_Response
	},
	{
		name: "WriteControllerAliasesAndUrls",
		options: { "google.api.http": {
			post: "/v1/controller/aliases-and-urls",
			body: "*"
		} },
		I: ControllerAPI_WriteAliasesAndUrls_Request,
		O: ControllerAPI_WriteAliasesAndUrls_Response
	},
	{
		name: "RemoveControllerAliasesAndUrls",
		options: { "google.api.http": {
			delete: "/v1/controller/aliases-and-urls",
			body: "*"
		} },
		I: ControllerAPI_RemoveAliasesAndUrls_Request,
		O: ControllerAPI_RemoveAliasesAndUrls_Response
	},
	{
		...
		I: ControllerAPI_GetUrl_Request,
		O: ControllerAPI_GetUrl_Response
	},
	{
		name: "ControllerSetFeatures",
		options: { "google.api.http": {
			post: "/v1/controller/features",
			body: "*"
		} },
		I: ControllerAPI_SetFeatures_Request,
		O: ControllerAPI_SetFeatures_Response
	},
	{
		name: "ControllerClearFeatures",
		options: { "google.api.http": {
	...
	},
	{
		...
		O: LocksAPI_Lease_Create_Response
	},
	{
		name: "UpdateLease",
		options: { "google.api.http": {
		...
		O: LocksAPI_Lease_Update_Response
	},
	{
		name: "ReleaseLease",
		options: { "google.api.http": {
		...
		O: LocksAPI_Lease_Release_Response
	},
	{
		name: "AuthMethods",
		options: { "google.api.http": { get: "/v1/auth/methods" } },
		I: AuthAPI_ListMethods_Request,
		O: AuthAPI_ListMethods_Response
	},
	{
		name: "GetJWTToken",
		options: { "google.api.http": {
	...
	},
	{
		...
		I: MiscAPI_ListResourceTypes_Request,
		O: MiscAPI_ListResourceTypes_Response
	},
	{
		name: "Ping",
		options: { "google.api.http": { get: "/v1/ping" } },
		I: MaintenanceAPI_Ping_Request,
		O: MaintenanceAPI_Ping_Response
	},
	{
		name: "License",
		options: { "google.api.http": { get: "/v1/license" } },
		I: MaintenanceAPI_License_Request,
