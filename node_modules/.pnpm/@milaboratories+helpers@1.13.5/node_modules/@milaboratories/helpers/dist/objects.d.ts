...
export declare function isNonPrimitive<V, T extends PlainObject<V> | V[]>(obj: T | unknown): obj is T;
...
export declare function map<U, T extends Record<string, unknown>>(obj: T, callback: (curr: T[keyof T], key: keyof T) => U): U[];
/**
 ...
 */
export declare const deepEqual: typeof isJsonEqual;
export declare function deepClone<T>(obj: T): T;
export declare function shallowClone<T>(obj: T): T;
export declare function shallowDiff<T>(to: T, from: T): Partial<T>;
export declare function bindMethods<O extends Record<string, unknown>>(obj: O): O;
export declare function setProp<O, K extends keyof O>(obj: O, key: K, value: O[K]): O;
export declare function getProp<O, K extends keyof O>(obj: O, key: K): O[K];
export declare function shiftProp<O, K extends keyof O>(obj: O, key: K): [O[K], Omit<O, K>];
export declare function pick<T, K extends keyof T>(obj: T, ...keys: K[]): Pick<T, K>;
export declare function pickValues<T, K extends keyof T>(obj: T, ...keys: K[]): T[K][];
 ...
 * ```
 */
export declare function deepPatch<T extends PlainObject | unknown[]>(target: T, source: T): T;
