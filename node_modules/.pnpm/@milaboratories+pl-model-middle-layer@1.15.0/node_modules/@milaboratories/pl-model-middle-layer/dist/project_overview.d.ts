...
type BlockCalculationStatus = "NotCalculated" | "Running" | "Done" | "Limbo";
/** Overview of the whole project state, required to render a left panel. */
type ProjectOverview = {
  /** Metadata, like project label associated with the project */meta: ProjectMeta; /** Creation timestamp. */
  created: Date; /** Last modification timestamp. */
  lastModified: Date;
  /**
   ...
   *   - block-pack update
   */
  authorMarker?: AuthorMarker; /** Overview information for each block */
  blocks: BlockStateOverview[];
};
/** Overview of the block state, required for visualization in the left panel */
type BlockStateOverview = {
  /** Project resource id (one of the goals it to be used for debugging purposes) */projectResourceId: string; /** Block id */
  id: string;
  /**
   ...
   * Undefined when block-pack for this block is not yet materialized.
   */
  tags: string[] | undefined; /** Block rendering mode */
   ...
   */
  exportsError?: string; /** Generalized block calculation status */
   ...
   * Undefined when block-pack for this block is not yet materialized.
   */
  isIncompatibleWithRuntime: boolean | undefined; /** Information on where the block pack for this block came from */
  currentBlockPack: BlockPackSpec | undefined;
  /**
   * If block pack update is available this field will contain latest specs to
   * perform the update
   */
  updatedBlockPack: BlockPackSpec | undefined; /** Current block settings */
  settings: BlockSettings; /** Detailed update options */
  updateSuggestions: UpdateSuggestions; /** Current navigation state of the block */
...
//#endregion
export { BlockCalculationStatus, BlockStateOverview, ProjectOverview };
