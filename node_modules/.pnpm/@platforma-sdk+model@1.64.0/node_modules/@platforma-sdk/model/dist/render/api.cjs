...
var ResultPool = class {
	...
	*/
	...
	getOptions(predicateOrSelector, opts) {
		const predicate = typeof predicateOrSelector === "function" ? predicateOrSelector : (0, _milaboratories_pl_model_common.legacyColumnSelectorsToPredicate)(predicateOrSelector);
